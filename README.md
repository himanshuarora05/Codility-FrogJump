As part of the of my interview process at EIP, I had to solve the following problem. I decided to use C# as a language to write a little program to solve it.
